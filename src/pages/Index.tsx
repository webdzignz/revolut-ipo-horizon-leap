          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h3 className="text-6xl md:text-7xl lg:text-8xl font-bold leading-tight text-black uppercase tracking-tight">
                  Invest In
                </h3>
                <h4 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-black uppercase tracking-tight">
                  Tomorrow
                </h4>
                <h5 className="text-7xl md:text-8xl lg:text-9xl font-bold leading-tight text-black uppercase tracking-tight">
                  Today
                </h5>
